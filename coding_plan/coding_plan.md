...
# 3. Choose your language and tools
### Status right now: 
- StoryCoder.dev](https://storycoder.dev/) runs with Wordpress with the Astra Theme.
...
#### Concerning Stories:
- Story texts 
- Story pictures: front pictures and further pictures, add correct cc licence for pictures
- AI generated text to speech audios, saved as mp3-files: add reference to used TTS engine on every story
- #####
...
- categorization: story tags and coding tags
